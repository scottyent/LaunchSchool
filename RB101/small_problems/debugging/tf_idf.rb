...
implementation of TF-IDF, a measure of the information content a
...
do not match what is expected. He knows you're enrolled in an
awesome developer school, so he asks you to have a look.

I looked through and saw that there was integer division
I wasn't sure if that was causing this behavior but it seemed likely
so I tested it with converting to float and it worked.
