...
# Test cases
p staggered_case('I Love Launch School!', start_caps=true, count_non_alphabetic = false) == 'I lOvE lAuNcH sChOoL!'
p staggered_case('ALL CAPS', start_caps=true, count_non_alphabetic=false) == 'AlL cApS'
p staggered_case('ignore 77 the 444 numbers', start_caps=true, count_non_alphabetic=false) == 'IgNoRe 77 ThE 444 nUmBeRs'
